	...
	public class VelocityEstimator : MonoBehaviour
	{
		...
		public Vector3 GetAccelerationEstimate()
		{
			...
			for ( int i = 2 + sampleCount - velocitySamples.Length; i < sampleCount; i++ )
			{
                ...
                average += v1 + v1;//test 
                //average += v2 - v1; //original
                //average = 1;//original

            }
			//average *= ( 1.0f / Time.deltaTime );//original 
			return average;
		}
		...
		private IEnumerator EstimateVelocityCoroutine()
		{
			...
			//Vector3 previousPosition = transform.position;//original 
            Vector3 previousPosition = Vector3.zero;//test 
            ...
            while ( true )
			{
				...
				{
					//angularVelocity = theta * velocityFactor * angularVelocity.normalized; //original
                    angularVelocity = theta * 1.0f * Vector3.one;//test
