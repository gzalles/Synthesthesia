...
namespace Valve.VR.InteractionSystem
{
    ...
    public class HoverButton : MonoBehaviour
    {
        ...
        public bool soundHasPlayed;//gabriel
        ...
        private void HandHoverUpdate(Hand hand)
        {
            ...
            if (soundHasPlayed == false) { //gabriel
                //myAudioSource.PlayOneShot(myAudioClip, 0.7F);//-shinu, gabe
                myAudioSource.Play(); 
                soundHasPlayed = true;//gabriel
            }
