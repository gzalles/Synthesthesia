...
namespace Valve.VR.InteractionSystem
{
	...
	public class LinearDrive : MonoBehaviour
	{
        ...
        protected void UpdateLinearMapping( Transform updateTransform )
		{
			...
			if ( repositionGameObject )
			{
				transform.position = Vector3.Lerp( startPosition.position, endPosition.position , linearMapping.value * 1.0f );
                //Debug.Log("update linear mapping: " + transform.position);
                // Debug.Log("update linear mapping2: " + transform.position * 2.0f );
            }
		}
        ...
        protected float CalculateLinearMapping( Transform updateTransform )
		{
            ...
            Debug.Log("CalculateLinearMapping: " + Vector3.Dot(displacement, direction) / length);
